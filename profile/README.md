...
| [**zer0dex**](https://github.com/hermes-labs-ai/zer0dex) | Dual-layer local memory for agents: a readable markdown index alongside vector retrieval. Reference implementation. | [Read the repository before adoption](https://github.com/hermes-labs-ai/zer0dex) |
